                     ...
                     <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-4 pointer-events-auto">
                       <div className={`flex items-center justify-center ${
                         ...
                         <Button
                           ...
                           variant="outline"
                           className="border-white/20 text-white hover:bg-white/10 px-3 py-2 sm:px-4 sm:py-2 rounded-lg text-sm sm:text-base"
                         ...
                         >
                           ...
                           <span className={`${isMobile ? 'inline' : 'hidden sm:inline'} ml-2`}>
