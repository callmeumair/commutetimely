  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 transition-all duration-300 backdrop-blur-xl bg-gradient-to-r from-[#0f3d3e]/90 via-[#1a1a1a]/90 to-[#0f3d3e]/90 shadow-lg border-b border-[#2EBFA5]/20">
      <div className="container-max flex items-center justify-between h-20 md:h-24">
        ...
        <Link
          href="/#download"
          className="hidden md:block relative group bg-gradient-to-r from-[#2EBFA5] to-[#1E8372] hover:from-[#24A892] hover:to-[#1E8372] text-white font-semibold rounded-xl px-6 py-3 text-base lg:text-lg focus:outline-none focus:ring-2 focus:ring-[#2EBFA5]/50 focus:ring-offset-2 focus:ring-offset-black transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
          aria-label="Download CommuteTimely app from app stores"
        >
          <Download className="w-5 h-5" aria-hidden="true" />
          <span>Download Now</span>
          {/* Subtext on hover */}
          <span className="absolute left-0 top-full mt-2 w-full text-xs text-center text-[#2EBFA5] opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
        ...
        {/* Mobile Menu Button */}
        <button
          className="md:hidden w-10 h-10 flex items-center justify-center text-white hover:text-[#2EBFA5] transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#2EBFA5]/50 focus:ring-offset-2 focus:ring-offset-black rounded"
