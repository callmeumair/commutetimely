  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 left-6 w-14 h-14 bg-gradient-to-r from-[#2EBFA5] to-[#1E8372] rounded-full shadow-lg hover:shadow-xl transition-all duration-200 z-50 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-[#2EBFA5]/50 focus:ring-offset-2 focus:ring-offset-black"
          ...
          >
              ...
              <div className="flex items-center justify-between p-4 border-b border-white/10">
                ...
                <button
                  ...
                  className="p-1 hover:bg-white/10 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#2EBFA5]/50 focus:ring-offset-2 focus:ring-offset-black"
              ...
              <form onSubmit={handleSubmit} className="p-4 border-t border-white/10">
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className="p-2 bg-[#2EBFA5] rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#24A892] active:bg-[#1E8372] transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#2EBFA5]/50 focus:ring-offset-2 focus:ring-offset-black"
