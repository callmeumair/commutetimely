      ...
      >
        <div className="container-max flex items-center justify-between h-20 md:h-24">
          ...
          <button
            ...
            className="hidden md:block relative group bg-gradient-to-r from-[#d4af37] to-[#b8941f] hover:from-[#e6c244] hover:to-[#d4af37] text-white font-semibold rounded-xl px-6 py-3 text-base lg:text-lg focus:outline-none focus:ring-2 focus:ring-[#d4af37]/50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
          ...
          <button
            ...
            className="md:hidden w-10 h-10 flex items-center justify-center text-white hover:text-[#d4af37] transition-colors duration-200"
          >
        ...
        >
          ...
          >
            <div className="p-6">
              ...
              <nav className="space-y-4 mb-8">
                {MENU.map((item) => (
                  <a
                    ...
                    href={item.href}
                    onClick={toggleMobileMenu}
                    className="block text-lg text-white hover:text-[#d4af37] font-medium transition-colors duration-200 py-3 border-b border-white/10"
                  >
                    {item.label}
                  </a>
                ))}
              ...
              <button
                onClick={handleDownload}
                className="w-full bg-gradient-to-r from-[#d4af37] to-[#b8941f] hover:from-[#e6c244] hover:to-[#d4af37] text-white font-semibold rounded-xl px-6 py-4 text-lg focus:outline-none focus:ring-2 focus:ring-[#d4af37]/50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center space-x-2"
              >
                <Download className="w-5 h-5" />
                <span>Download Now</span>
              </button>
