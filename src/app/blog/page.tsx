...
const ARTICLES = [
  {
    slug: "how-we-fuse-live-traffic-transit-and-weather-into-a-single-departure-signal",
    tag: "Engineering",
    tagColor: "#6E5CFF",
  ...
  {
    slug: "the-invisible-ui-principle-why-commutetimely-has-zero-manual-inputs",
    tag: "Product",
    tagColor: "#10B981",
  ...
  {
    slug: "why-historical-commute-patterns-matter-as-much-as-live-traffic",
    tag: "Insight",
    tagColor: "#F59E0B",
  ...
  {
    slug: "privacy-first-by-design-what-data-not-collected-actually-means",
    tag: "Privacy",
    tagColor: "#3A7BFF",
  ...
  {
    slug: "building-a-real-time-commute-engine-lessons-from-early-development",
    tag: "Engineering",
    tagColor: "#6E5CFF",
  ...
  {
    slug: "the-commute-is-not-dead-why-hybrid-work-made-arrival-intelligence-more-important",
    tag: "Culture",
    tagColor: "#00D4FF",
    ...
    <Link href={`/blog/${article.slug}`} className="block h-full group">
      ...
      >
        <div className="p-6 flex flex-col flex-1">
          ...
          <h3 className="text-[15px] font-semibold text-white leading-snug mb-3 flex-1 group-hover:text-white transition-colors">
            {article.title}
          </h3>
            ...
            >
              <div className="p-8 sm:p-10 grid sm:grid-cols-[1fr_auto] gap-8 items-start">
                <div>
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 leading-snug max-w-2xl group-hover:text-white transition-colors">{FEATURED.title}</h2>
